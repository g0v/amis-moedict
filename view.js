...
(function(){
  ...
  Term = createClass({
    render: function(){
      var ref$, LANG, H, ref1$, title, english, heteronyms, radical, nrsCount, sCount, py, xrefs, tag, stem, aStroke, $char, list, res$, i$, len$, key, props;
      ref$ = this.props, LANG = ref$.LANG, H = (ref1$ = ref$.H) != null
        ? ref1$
        : HASHOF[LANG], title = ref$.title, english = ref$.english, heteronyms = ref$.heteronyms, radical = ref$.radical, nrsCount = ref$.non_radical_stroke_count, sCount = ref$.stroke_count, py = ref$.pinyin, xrefs = ref$.xrefs, tag = ref$.tag, stem = ref$.stem;
      H = replace$.call(H, /^#/, '');
      H = DotSlash + "#" + H;
  ...
  Heteronym = createClass({
    render: function(){
      ...
      if (/<rb/.test(titleRuby)) {
        console.warn('Should render ruby tags: ' + titleRuby)
      }
      list = [
